...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  tccoin-cli [options] <command> [params]  " + _("Send command to Bitcoin Core") + "\n" +
                  "  tccoin-cli [options] help                " + _("List commands") + "\n" +
                  "  tccoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
